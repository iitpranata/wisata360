<div style="height: 60px; padding-top: 10px; background-color : #ececec; padding-bottom: 11px;">
<h3 style="margin-top: 10px; margin-left: 100px;">Populer</h3>
</div>
<div class="android-more-section">
  <div class="android-card-container mdl-grid">
    <?php foreach ($populer_semua as $row) {?>
