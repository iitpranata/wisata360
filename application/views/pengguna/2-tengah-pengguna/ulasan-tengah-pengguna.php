...
<div class="android-more-section">
	...
	<div class="mdl-grid">
		...
		<a href="<?php echo base_url().'pengguna/ulasan/' ?>" target="_blank" class="mdl-button mdl-js-button mdl-button--raised"> <i class="material-icons">chevron_right</i> Selanjutnya</a>
		</div>
		<div class="mdl-layout-spacer"></div>
	</div>
</div>