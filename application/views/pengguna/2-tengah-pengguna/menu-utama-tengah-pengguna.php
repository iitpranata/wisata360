<div class="android-header mdl-layout__header mdl-layout__header--waterfall">
        <div class="mdl-layout__header-row">
          ...
          <?php if($this->session->userdata('userData')['oauth_uid'] > 0){ ?>
            <nav class="android-navigation mdl-navigation">
              ...
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="<?php echo base_url(); ?>">Tentang</a>            
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="<?php echo base_url(); ?>">Hubungi</a>            
              <!-- <img src="<?php //echo $this->session->userdata('userData')['picture_url']; ?>" width="35px" height="30px"> -->
              <b style="color : #7e7777; padding-top: 6px;padding-left: 25px;"><?php echo $this->session->userdata('userData')['first_name']." ".$this->session->userdata('userData')['last_name']; ?></b>            
      ...
      <div class="android-drawer mdl-layout__drawer mdl-layout--small-screen-only">
        ...
        <nav class="mdl-navigation">
          <a class="mdl-navigation__link" href="<?php echo base_url(); ?>index.php/pengguna_login_facebook/"><i class="material-icons">collections</i> DESTINASI</a>
          <a class="mdl-navigation__link" href="<?php echo base_url(); ?>index.php/pengguna_login_facebook/"><i class="material-icons">info_outline</i> TENTANG</a>
          <a class="mdl-navigation__link" href="<?php echo base_url(); ?>index.php/pengguna_login_facebook/"><i class="material-icons">email</i> HUBUNGI</a>
          <div class="mdl-layout-spacer" style="width: 240px;height: 140px;"></div>
