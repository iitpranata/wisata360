...
<div class="mdl-cell mdl-cell--8-col">
   <div style="height: 45px; background-color : #ececec; margin-bottom: 5px; margin-top: 10px;">
	  <h6 style="margin-top: 0px; margin-bottom: 0px; padding-top: 10px; padding-left: 10px;"><i class="fa fa-comment" aria-hidden="true"></i> 
	  <?php 
...
<div class="mdl-cell mdl-cell--4-col">
   ...
   <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-card mdl-shadow--4dp">
