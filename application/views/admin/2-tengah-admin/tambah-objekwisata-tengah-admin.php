...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--6-col">
        <?php echo form_open_multipart( '/admin_tambah/objek_wisata'); ?>
        ...
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <?php $alamat=array( 'class'=>'mdl-textfield__input', 'type' => 'text', 'id' => 'alamat_wisata'); echo form_input('alamat_wisata', '', $alamat); $label_alamat = array('class' => 'mdl-textfield__label'); echo form_label('Alamat','alamat_wisata', $label_alamat); ?></div>
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
            <input class="mdl-textfield__input" name="kategori_wisata" type="text" id="kategori_wisata" value="" readonly tabIndex="-1">
    ...
    <div class="mdl-cell mdl-cell--6-col">
        ...
        <div class="mdl-cell mdl-cell--12-col">
            <img id="foto360" src="#" alt="" style='width:100%;' border="0" alt="Null" />
        </div>
    </div>
