...
class Belakang_filter_text_model extends CI_Model{
	...
	public function filtering($hasiltoken){
		...
		$this->db->select('kata__objek_wisata__stopwords');
		$this->db->from('objek_wisata__stopwords');
		$arraystopwords = $this->db->get()->result_array();

		//ubah ke associative array
		$arraystopwords= array_column($arraystopwords,'kata__objek_wisata__stopwords');
	...
	public function stemming($hasilfiltered){
		...
		$this->db->select('kata__objek_wisata__katadasar');
		$this->db->from('objek_wisata__katadasar');
		$arraykatdas = $this->db->get()->result_array();

		//ubah ke associative array
		$this->arraykatadasar = array_column($arraykatdas,'kata__objek_wisata__katadasar');
	...
	public function objek_wisata_ulasan($id_objekwisata, $objek_wisata__ulasan){

		$hasiltoken = $this->tokenizing($objek_wisata__ulasan);
		$hasilfilter = $this->filtering($hasiltoken);
		$hasilstemming = $this->stemming($hasilfilter); 

		//insert ke database
		$this->db->insert('objek_wisata__ulasan',['tokenized__objek_wisata__ulasan'=>$hasiltoken,'filtered__objek_wisata__ulasan'=>$hasilfilter,'stemmed__objek_wisata__ulasan'=>$hasilstemming, 'objek_wisata__post_id__objek_wisata__post' => $id_objekwisata]);
